...
class Team(SQLModel, table=True):
    ...
    name: str
    hero: "Hero" = Relationship(back_populates='team', cascade_delete=True)
...
class Hero(SQLModel, table=True):
    ...
    secret_name: str
    age: int | None = None
    team_id: int | None = Field(default=None, foreign_key='team.id', ondelete='CASCADE', unique=True)
    team: Team | None = Relationship(back_populates='hero')
